...
kiss_obj* kiss_garef(const kiss_obj* const array, const kiss_obj* const rest) {
     ...
     default:
	  fprintf(stderr, "garef: unexpeced primitive obj type %ld", KISS_OBJ_TYPE(array));
	  exit(EXIT_FAILURE);
     }
}
...
kiss_obj* kiss_aref(const kiss_obj* const array, const kiss_obj* const rest) {
     ...
     default:
	  fprintf(stderr, "aref: unexpected primitive obj type %ld", KISS_OBJ_TYPE(array));
	  exit(EXIT_FAILURE);
     }
}
...
kiss_obj* kiss_set_garef(const kiss_obj* const obj, kiss_obj* const array, const kiss_obj* const rest)
{
     ...
     default:
	  fprintf(stderr, "set-garef: unexpeced primitive obj type %ld", KISS_OBJ_TYPE(array));
	  exit(EXIT_FAILURE);
     }
}
...
kiss_obj* kiss_array_dimensions(const kiss_obj* const array) {
     ...
     default:
	  fprintf(stderr, "array-dimensions: unexpected primitive obj type %ld",
                  KISS_OBJ_TYPE(array));
	  exit(EXIT_FAILURE);
     }
...
kiss_obj* kiss_basic_array_p (const kiss_obj* const obj) {
     ...
     case KISS_GENERAL_ARRAY:
	  return KISS_T;
     default:
	  fprintf(stderr, "basic-array-p: unknown primitive obj type %ld", KISS_OBJ_TYPE(obj));
	  exit(EXIT_FAILURE);
     }
}
...
kiss_obj* kiss_general_array_s_p (const kiss_obj* const obj) {
     ...
     case KISS_GENERAL_ARRAY:
	  return KISS_T;
     default:
	  fprintf(stderr, "general-array*-p: unknown primitive obj type %ld", KISS_OBJ_TYPE(obj));
	  exit(EXIT_FAILURE);
     }
}
